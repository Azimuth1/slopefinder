...
elevation.clip(bounds=(-78.9229568629999960,38.9524045909233294, -78.8717227540000039,39.0085208110766644), output='TroutPass-DEM.tif')
# clean up stale temporary files and fix the cache in the event of a server error
elevation.clean()


# read GeoTiff Data using rasterio
dataset = rasterio.open('RandomAerial4326.tiff')
